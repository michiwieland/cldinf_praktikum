...
\begin{itemize}
	...
	% BR netze
	\item Bei den Switches in den Branches sind die VLANs nicht auf den Ports zugeordner.
	\item Beim BR1\_S2, BR1\_S3, BR1\_S4 sind die Trunk-Ports zum Router nicht richtig konfiguriert (nämlich access und spanning-tree portfast)
\end{itemize}
